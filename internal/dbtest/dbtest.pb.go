...
type StoreTestRental struct {
	...
	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" gorm:"primary_key"`
	// @inject_tag: `gorm:"primary_key"`
	CarId string `protobuf:"bytes,2,opt,name=car_id,json=carId,proto3" json:"car_id,omitempty" gorm:"primary_key"`
	// create_time from the RDBMS
	// @inject_tag: `gorm:"default:CURRENT_TIMESTAMP"`
...
var file_dbtest_storage_v1_dbtest_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_dbtest_storage_v1_dbtest_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_dbtest_storage_v1_dbtest_proto_depIdxs = []int32{
	4, // 0: dbtest.storage.v1.Timestamp.timestamp:type_name -> google.protobuf.Timestamp
